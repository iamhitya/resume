...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.Hero, SectionId.About, SectionId.Skills, SectionId.Experience, SectionId.Education, SectionId.Certifications, SectionId.Testimonials, SectionId.Contact],
    [],
  );
